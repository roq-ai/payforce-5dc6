...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'currency.update': {
    roles: ['business-owner', 'finance-manager'],
    key: 'updated-exchange-rate',
    tenantPath: [],
    userPath: [],
  },
  'verification.create': {
    roles: ['business-owner', 'finance-manager'],
    key: 'new-payment-verification',
    tenantPath: ['organization', 'user', 'transaction', 'verification'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'finance-manager'];
