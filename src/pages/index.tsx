...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Payforce`}</title>

        <meta
          name="description"
          content="Unleash the power of convenience with Payforce! Effortlessly pay online, stay updated with real-time foreign exchange rates, and enjoy hassle-free payment verification. Simplify your financial transactions - Get started with Payforce today!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1563013544-824ae1b704d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxvbmxpbmUlMjBwYXltZW50fGVufDB8fHx8MTY5Mzc2OTg5NXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash the power of convenience with Payforce! Effortlessly pay online, stay updated with real-time foreign exchange rates, and enjoy hassle-free payment verification. Simplify your financial transactions - Get started with Payforce today!`}
            </Text>
            <Box
