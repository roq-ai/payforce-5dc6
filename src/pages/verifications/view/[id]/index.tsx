...
import { getVerificationById } from 'apiSdk/verifications';
import { VerificationInterface } from 'interfaces/verification';

function VerificationViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('verification', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/verifications/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                {hasAccess('transaction', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Transaction"
                    text={
                      <Link as={NextLink} href={`/transactions/view/${data?.transaction?.id}`}>
