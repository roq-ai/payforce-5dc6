...
import { VerificationListPage } from 'pages/verifications';
  ...
  const { data, error, isLoading, mutate } = useSWR<TransactionInterface>(
    ...
    () =>
      getTransactionById(id, {
        relations: ['payment_option', 'currency', 'user'],
      }),
  );
              ...
              >
                ...
                {hasAccess('payment_option', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    ...
                    text={
                      <Link as={NextLink} href={`/payment-options/view/${data?.payment_option?.id}`}>
