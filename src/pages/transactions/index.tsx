...
export function TransactionListPage(props: TransactionListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTransactions({
        relations: ['payment_option', 'currency', 'user', 'verification.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('payment_option', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'payment_option',
          ...
          cell: ({ row: { original: record } }: any) => (
            <Link
              ...
              href={`/payment-options/view/${record.payment_option?.id}`}
            >
              {record.payment_option?.name}
            </Link>
          ),
        }
      : null,
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('verification', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'verification',
          header: 'Verification',
          accessorKey: 'verification',
          cell: ({ row: { original: record } }: any) => record?._count?.verification,
        }
      : null,
